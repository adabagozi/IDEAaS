 ...
 */
public abstract class MyCFCluster extends MySphereCluster {
	 ...
	 * this kernel.
	 */
	public MyCFCluster(Instance instance, int dimensions) {
		this(instance.toDoubleArray(), dimensions);
	}

	protected MyCFCluster(int dimensions) {
		this.N = 0;
	...
	public MyCFCluster(double [] center, int dimensions) {
		this.N = 1;
		this.LS = center;
		this.SS = new double[dimensions];
