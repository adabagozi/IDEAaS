...
public class MyParallelCluStreamAlgorithmBuffer extends MyAbstractClusterer implements ICluStreamAlgorithm {
...
//	private List<MyClustreamKernel> buffer; // Buffer for initialization with kNN
	...
	public MyParallelCluStreamAlgorithmBuffer(CluStreamAlgorithmImplementation algorithm) throws Exception {
...
//		resetLearningImpl();
	...
	public MyParallelCluStreamAlgorithmBuffer(CluStreamAlgorithmImplementation algorithm, JavaSparkContext sparkContext) throws Exception {
		this.distanceComputer = new DistanceComputer();
		this.iDistanceComputer = DistanceComputerFactory.getDAOFactory().getDistanceComputer(algorithm, sparkContext);
//		resetLearningImpl();
	}
