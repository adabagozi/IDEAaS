...
public class MyCluStreamAlgorithm extends MyAbstractClusterer implements ICluStreamAlgorithm {
	...
	public MyCluStreamAlgorithm() {
		this.iDistanceComputer = DistanceComputerFactory.getDAOFactory().getDistanceComputer();
	}
	
	public MyCluStreamAlgorithm(String distanceIdentificator) {
