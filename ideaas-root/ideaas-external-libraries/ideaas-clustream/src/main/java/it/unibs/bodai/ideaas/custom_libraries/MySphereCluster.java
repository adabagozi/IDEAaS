 ...
 *
 */
public class MySphereCluster extends MyCluster {
	...
	public MySphereCluster(double[] center, double radius) {
		this( center, radius, 1.0 );
	}
	
	public MySphereCluster(double[] center, double radius, ArrayList<MyClustreamKernel> kernels) {
		this( center, radius, 1.0 );
		this.setKernels(kernels);
	}

	public MySphereCluster() {
	}

	public MySphereCluster( double[] center, double radius, double weightedSize) {
		this();
		this.center = center;
		this.radius = radius;
	...
	public MySphereCluster(int dimensions, double radius, Random random) {
		this();
	...
	public MySphereCluster(List<?extends Instance> instances, int dimension){
		this();
	...
	public double overlapRadiusDegree(MySphereCluster other) {
	...
	public void combine(MySphereCluster cluster) {
	...
	public void merge(MySphereCluster cluster) {
		double[] c0 = getCenter();
		double w0 = getWeight();
		double r0 = getRadius();
	...
	public double getCenterDistance(MySphereCluster other) {
	 ...
	 */
	public double getHullDistance(MySphereCluster other) {
		double distance = 0.0;
		//get the center through getCenter so subclass have a chance
		double[] center0 = getCenter();
		double[] center1 = other.getCenter();
	 ...
	 */
	public boolean overlapSave(MySphereCluster other){
	...
	public double[] getDistanceVector(MySphereCluster other){
