...
public class MyCluStreamAlgorithmNoRemove extends MyAbstractClusterer implements ICluStreamAlgorithm {
	...
	public MyCluStreamAlgorithmNoRemove() {
		this.iDistanceComputer = DistanceComputerFactory.getDAOFactory().getDistanceComputer();
	}
	
	public MyCluStreamAlgorithmNoRemove(String distanceIdentificator) {
...
//			kernels[oldestIndex].instances.add(instance);
		}
	}
