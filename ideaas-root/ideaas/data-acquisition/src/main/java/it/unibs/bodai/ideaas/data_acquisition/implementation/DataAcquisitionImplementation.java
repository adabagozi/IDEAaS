 ...
 */
public class DataAcquisitionImplementation implements IDataAcquisition {
	private IDAO dao;
...
//	Logger mySQLLogger = Logger.getLogger("com.mysql.jdbc.log.StandardLogger");
	 ...
	 * @param iDAO
	 */
	protected DataAcquisitionImplementation(IDAO iDAO) {
		this.dao = iDAO;
	...
	public DataAcquisitionImplementation() throws IOException {
		// this.dao = iDAO;
					...
					if (rowElement != "") {
						...
						default:// reading components parameters
							...
							if (!compStrings[compPosition].isEmpty()) {
								dimensionInstances.add(this.dao.readDimensionInstanceWithParentId("Componente",
										componentSplit + compStrings[compPosition], machineDimInstance.getId()));
							}
							measure.setDimensionInstances(dimensionInstances);
