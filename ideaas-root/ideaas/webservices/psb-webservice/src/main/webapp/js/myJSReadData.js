...
function getDataFromServer(url, isTest, day){

	var dateValues = ["2016-07-"+day+"T00:00:00.000Z",
		"2016-07-"+day+"T01:00:00.000Z",
		"2016-07-"+day+"T02:00:00.000Z",
		"2016-07-"+day+"T03:00:00.000Z",
		"2016-07-"+day+"T04:00:00.000Z",
		"2016-07-"+day+"T05:00:00.000Z",
		"2016-07-"+day+"T06:00:00.000Z",
		"2016-07-"+day+"T07:00:00.000Z",
		"2016-07-"+day+"T08:00:00.000Z",
		"2016-07-"+day+"T09:00:00.000Z",
		"2016-07-"+day+"T10:00:00.000Z",
		"2016-07-"+day+"T11:00:00.000Z",
		"2016-07-"+day+"T12:00:00.000Z",
		"2016-07-"+day+"T13:00:00.000Z",
		"2016-07-"+day+"T14:00:00.000Z",
		"2016-07-"+day+"T15:00:00.000Z",
		"2016-07-"+day+"T16:00:00.000Z",
		"2016-07-"+day+"T17:00:00.000Z",
		"2016-07-"+day+"T18:00:00.000Z",
		"2016-07-"+day+"T19:00:00.000Z",
		"2016-07-"+day+"T20:00:00.000Z",
		"2016-07-"+day+"T21:00:00.000Z",
		"2016-07-"+day+"T22:00:00.000Z",
		"2016-07-"+day+"T23:00:00.000Z"
	];
...
function readDataResult(resultData, id, datetimeValue){
		...
		plotAsync(queue, keys, datetimeValue);
}

function plotAsync(queue, keys, datetimeValue){
	...
	if(queue.length>0){
		setTimeout(function() {
			...
			plotGraph("graph"+data.id, data.newData, data2, keys, datetimeValue);
			$('#loader'+data.id).hide();
...
function addElementsResultData(id, datetime){
	...
	$('#resultData').append('<div class="row" style=""><div class="col-xs-12"> '+
									'<div class="col-xs-6 loader" id="loader'+id+'"></div>' +
									'<div id="graph'+id+'" style="min-width: 310px; height: 600px; marign-bottom: 20px; margin: 0 auto;"></div>'+
								'<hr></div></div>');
}
